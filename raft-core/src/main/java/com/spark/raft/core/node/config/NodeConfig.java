package com.spark.raft.core.node.config;
...
public class NodeConfig {
     ...
     */
    private int maxReplicationEntries = -1; //Log.ALL_ENTRIES;

    /**
     * Max entries to send when replicate log to new node
     */
    private int maxReplicationEntriesForNewNode = -1; //Log.ALL_ENTRIES;
